...
public class GenericLinkedList <T> {
    ...
    public void add(T value, int index) throws ElementAlreadyInTheListException {
        if (isEmpty()) {
            add(value);
            return;
        }
    ...
    public boolean remove(T value) throws ElementIsNotInTheListException, IndexOutOfBoundsException {
